...
(function () {
	...
	$(function () {
		...
		(function ($) {
			var w = canvas.width = document.getElementById("header").offsetWidth,
					h = canvas.height = document.getElementById("header").offsetHeight,
					center = {x: w / 2, y: h / 2},
					count = 7,
					...
					T = Math.PI * 2,
					circleRadius = 60,
					mainCircleRadius = (Math.min(w, h) - circleRadius * 2 - 10) / 2.5;
			...
			function anim() {
				...
				for (var i = 0; i < count; ++i) {
					var rad = mainCircleRadDist * i,
							x = Math.cos(rad) * mainCircleRadius + center.x,
							y = Math.sin(rad) * mainCircleRadius + center.y;
